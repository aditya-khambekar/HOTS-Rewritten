...
public abstract class SuperstructureState{
    ...
    public static SuperstructureState of(Dimensionless elevatorProportion, Rotation2d wristRotation, Dimensionless wheelDutyCycle) {
        return new ImmutSuperstructureState(elevatorProportion, wristRotation, wheelDutyCycle);
    }

    public static MutSuperstructureState mutable(Dimensionless elevatorProportion, Rotation2d wristRotation, Dimensionless wheelDutyCycle) {
