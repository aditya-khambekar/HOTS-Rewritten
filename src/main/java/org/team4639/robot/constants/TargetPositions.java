...
public enum TargetPositions {
    ...
    BARGE_FARCAGE(
            new Pose2d(FieldConstants.Barge.farCage, Rotation2d.kZero).transformBy(FieldConstants.fromBarge)),
    BARGE_MIDDLECAGE(
            new Pose2d(FieldConstants.Barge.middleCage, Rotation2d.kZero).transformBy(FieldConstants.fromBarge)),
    BARGE_CLOSECAGE(
            new Pose2d(FieldConstants.Barge.closeCage, Rotation2d.kZero).transformBy(FieldConstants.fromBarge)),
